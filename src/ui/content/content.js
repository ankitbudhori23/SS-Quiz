export const importantToKnow = [
    "The total number of questions are 10",
    "You will have 20 seconds for each question. If you fail to complete a question in given time, your answer will be considered incorrect.",
  ];
